...
In water at $298K$, \ch{Ca^{2+}} has an ion mobility of $u=6.17\times10^{-8}\frac{m^2}{V~s}$ and \ch{Br^-} has an ion mobility of \\$u=8.09\times10^{-8}\frac{m^2}{V~s}$. Use the viscosity of water ($0.0089\frac{kg}{m~s}$) to find the Stokes radius of each ion
